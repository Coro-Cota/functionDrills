...
console.log(exclaimTwo("wake up"));
console.log('arrow')
// console.log('declaration')
// console.log('expression')
...
console.log(exclaimFour("wake up"))
// console.log('arrow')
console.log('declaration')
// console.log('expression')
...
function bestMovie(string){
  console.log(`${string} is the best movie ever!`)
}
...
console.log(emailCheck("    somtheing@gmail.com"))
